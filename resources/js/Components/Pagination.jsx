                            ...
                            <Link
                                ...
                                className={`${
                                    link.label === "&laquo; Previous"
                                        ? "flex items-center justify-center px-4 h-10 ms-0 leading-tight   border border-e-0 border-gray-300 rounded-s-lg    dark:border-gray-700 "
                                        : link.label === "Next &raquo;"
                                        ? "flex items-center justify-center px-4 h-10 leading-tight   border border-gray-300 rounded-e-lg  hover:text-gray-700  dark:border-gray-700 "
